...
public class SimpleSwipeLook : MonoBehaviour {
	//-----------------------------------------------------------------------------------------
	// Inspector Variables:
	//-----------------------------------------------------------------------------------------
	...
	protected void Update() {
		activeVelocityX = Mathf.Lerp(activeVelocityX, 0, (1f / smoothing) * Time.deltaTime);
		activeVelocityY = Mathf.Lerp(activeVelocityY, 0, (1f / smoothing) * Time.deltaTime);
